...
namespace SteamAutoLogin
{
    public static class EasyOcrHelper
    {
        ...
        /// <summary>
        /// Captures the contents of a window and saves it to a PNG in the application's base directory.
        /// </summary>
        ...
        /// <summary>
        /// Calls a Python script (easyocr_server.py) to perform OCR on the specified image.
        /// The script must exist in the same directory as the executing assembly.
        /// </summary>
        public static JArray RunEasyOcr(string imagePath)
        {
            // Adjust the path to Python as needed for your environment
        ...
        /// <summary>
        /// Searches for a button with matching keywords in the OCR results and clicks it.
        /// </summary>
        ...
        /// <summary>
        /// Repeatedly attempts to detect and click a button identified by the given keywords,
        /// waiting between attempts. If no button is found before the retry limit, a message
